...
export function familyGuideSections(base = '') {
  return [
    ...
    },
    {
      ...
      summary: 'صحّح الاسم أو الأفراد، أو عبّي بيانات الفلترة الناقصة من القوائم.',
      steps: [
        'من ملفي: تعديل الملف.',
        'الحالة الاجتماعية والجنس وصلة القرابة اختاروها من القائمة، مش كتابة.',
        'أرسلوا الطلب. اللجنة توافق قبل ما يتغيّر السجل.',
      ],
    },
    {
      id: 'requests',
